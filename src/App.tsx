...
export default function Home() {
  ...
  console.log("Contract Metadata:", {
    isLoading: contractMetadata.isLoading,
    data: contractMetadata.data,
    error: contractMetadata.error
  });

  console.log("First NFT:", {
    data: firstNft,
    isLoading: firstNftLoading
  });
  ...
  return (
    <div className="w-screen h-screen overflow-hidden">
      ...
      <div className="h-full grid grid-cols-1 lg:grid-cols-12">
        <div className="items-center justify-center hidden w-full h-full lg:col-span-5 lg:flex lg:px-8">
        ...
        <div className="flex items-center justify-center w-full h-full col-span-1 lg:col-span-7">
          <div className="flex flex-col w-full max-w-xl gap-3 p-8 rounded-xl lg:border lg:border-gray-400 lg:dark:border-gray-800">
            <div className="flex w-full mt-4 xs:mb-4 xs:mt-0 lg:hidden">
              <HeadingImage
                src="/nft.png"
                isLoading={false}
              />
